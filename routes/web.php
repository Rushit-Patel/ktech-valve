...
Route::get('/{category}', [FrontendProductController::class, 'category'])->name('products.category');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        Route::post('settings/remove-file', [SettingsController::class, 'removeFile'])->name('settings.remove-file');
