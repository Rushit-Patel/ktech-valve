...
@section('styles')
    <style>
        ...
        /* Removed pattern overlay for clearer images */
        .slider-item::after {
            display: none;
        }
...
<div class="hero-slider relative" role="banner" aria-label="Company Hero Slider">
    ...
    <div id="heroSlider" class="relative h-screen">
        ...
        style="background-image: url('{{ asset('storage/' . $banner->image) }}')" @else
                        ...
                        <div class="slider-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">                            <div class="text-center">
                                <!-- Enhanced Title with Staggered Animation -->
                                <h1 class="hero-title text-5xl md:text-7xl font-black text-white mb-6 leading-tight">
                                    {{ $banner->title }}
                                    @if($banner->subtitle)
                                        <span class="hero-subtitle block text-4xl md:text-5xl font-bold mt-4">{{ $banner->subtitle }}</span>
                                    @endif
                                </h1>
                                ...
                                @endif                                <!-- Enhanced CTA Buttons with Icons and Animations -->
                                ...
                                <!-- Enhanced Key Stats (only show on first slide) -->
                                @if($index === 0)
                                    <div
                                        class="stats-container max-w-5xl mx-auto">
                                        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                                            <div class="stat-item text-center group">
                                                <div class="stat-number text-4xl md:text-5xl font-black mb-3">
                                                    {{ $stats['total_products'] ?? '250+' }}</div>
                                ...
                                @if($index === 0)                                    <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white animate-bounce">
                ...
                @if($banners->count() > 1)
                    ...
                    <!-- Play/Pause Control -->
                    <button
                        class="absolute top-8 right-8 z-5 bg-white bg-opacity-20 hover:bg-opacity-30 text-white p-3 rounded-full backdrop-filter backdrop-blur-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50"
                        id="playPauseBtn" aria-label="Pause slideshow" title="Pause/Play slideshow">
                        <svg class="w-5 h-5" id="pauseIcon" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M6 4h4v16H6V4zm8 0h4v16h-4V4z" />
                        </svg>
                        <svg class="w-5 h-5 hidden" id="playIcon" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div class="card-hover bg-white rounded-2xl shadow-lg overflow-hidden group">
                    <div
                        ...
                        <div class="relative text-center text-white z-10">
                            <div
                                class="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            @foreach($featuredProducts->take(8) as $product)
                <div class="card-hover bg-white rounded-2xl shadow-lg overflow-hidden group">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-orange-600 transition-colors duration-300">
                            {{ $product->name }}
                        </h3>
...
<div class="bg-gray-50 py-16 lg:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                K-Tech Valves maintains the highest industry standards through rigorous certification processes and quality management systems.
            </p>
        </div>
        ...
        @if($certifications && $certifications->count() > 0)
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                @foreach($certifications->take(8) as $certification)
                    <div class="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 card-hover text-center">
                        ...
                        @else
                            <div class="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-blue-500 to-blue-700 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="text-center mt-16">
            <div class="bg-white rounded-2xl p-8 lg:p-12 shadow-lg">
                ...
                <p class="text-lg text-gray-600 mb-8 max-w-3xl mx-auto">
                    Our certifications demonstrate our unwavering commitment to quality, safety, and environmental responsibility. Every valve we manufacture meets or exceeds international standards.
                </p>
                <a href="{{ route('certifications') ?? '#' }}" class="inline-flex items-center px-6 py-3 border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white font-semibold rounded-full transition-colors duration-300">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <p class="text-xl text-gray-600 leading-relaxed mb-8">
                    {{ \App\Helpers\SiteHelper::get('company_description', 'Leading manufacturer of high-quality industrial valves for diverse applications worldwide.') }}
                </p>
                ...
                <div class="space-y-6 mb-8">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Every valve undergoes rigorous testing to meet international standards and exceed customer expectations.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Cutting-edge technology and continuous R&D drive our innovative valve solutions.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">{{ \App\Helpers\SiteHelper::getExperienceYears() }}+ years of experience serving customers worldwide across multiple industries.</p>
                        </div>
                    </div>
                </div>
                
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('about') }}" class="inline-flex items-center px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg transition-colors duration-300">
                        Learn More About Us
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                        </svg>
                    </a>
                    <a href="{{ route('products.index') }}" class="inline-flex items-center px-6 py-3 border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white font-semibold rounded-lg transition-colors duration-300">
                        View Our Products
                    </a>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div class="bg-gradient-to-br from-blue-50 to-orange-50 rounded-2xl p-8">
                    <div class="grid grid-cols-2 gap-6">
                        <div class="text-center">
                            <div class="text-3xl font-black text-orange-500 mb-2">{{ $stats['total_products'] ?? '250+' }}</div>
                            <div class="text-sm text-gray-600 font-semibold">Products</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-black text-orange-500 mb-2">{{ $stats['total_clients'] ?? '500+' }}</div>
                            <div class="text-sm text-gray-600 font-semibold">Clients</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-black text-orange-500 mb-2">{{ $stats['total_industries'] ?? '15+' }}</div>
                            <div class="text-sm text-gray-600 font-semibold">Industries</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-black text-orange-500 mb-2">{{ \App\Helpers\SiteHelper::getExperienceYears() }}</div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="aspect-square bg-gray-200 rounded-xl overflow-hidden">
                        @if($gallery->image)
                        <img src="{{ asset('storage/' . $gallery->image) }}" alt="{{ $gallery->title }}" class="w-full h-full object-cover hover:scale-110 transition-transform duration-500">
                        @endif
                    </div>
                    @endforeach
                </div>
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            let currentSlide = 0;
            let isPlaying = true;
            let autoPlayInterval = 8000; // 8 seconds
            let autoPlay;
            ...
            function showSlide(index, direction = 'next') {
                ...
                if (slides[previousSlide]) {
                    slides[previousSlide].style.transition = 'all 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94)';
                    slides[previousSlide].style.opacity = '0';
                    slides[previousSlide].style.transform = direction === 'next' ? 'scale(0.95) translateX(-100px)' : 'scale(0.95) translateX(100px)';
