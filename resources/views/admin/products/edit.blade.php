                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="features" 
                                  ...
                                  placeholder="Key product features (one per line)">{{ old('features', $product->features) }}</textarea>
                        @error('features')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="applications" 
                                  ...
                                  placeholder="Product applications and use cases">{{ old('applications', $product->applications) }}</textarea>
                        @error('applications')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="specifications" 
                                  ...
                                  placeholder="Technical specifications (JSON format)">{{ old('specifications', is_array($product->specifications) ? json_encode($product->specifications, JSON_PRETTY_PRINT) : $product->specifications) }}</textarea>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" 
                                  ...
                                  placeholder="Brief description for search engines (150-160 characters)">{{ old('meta_description', $product->meta_description) }}</textarea>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                @if($product->featured_image)
                    <div class="mb-4">
                        <img src="{{ Storage::url($product->featured_image) }}" alt="{{ $product->name }}" class="w-full h-32 object-cover rounded-lg border border-gray-200">
                    ...
                    <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <label for="featured_image" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                <span>{{ $product->featured_image ? 'Replace image' : 'Upload a file' }}</span>
                ...
                <div class="grid grid-cols-2 gap-3">
                    @foreach($product->gallery_images as $index => $image)
                        <div class="relative group">
                            ...
                            <label class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 rounded-lg">
                ...
                <div class="space-y-2">
                    @foreach($product->documents as $index => $document)
                        <div class="flex items-center justify-between p-2 border border-gray-200 rounded-lg">
                            <span class="text-sm text-gray-600">{{ basename($document) }}</span>
                            <label class="flex items-center">
                                <input type="checkbox" name="remove_documents[]" value="{{ $index }}" class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded">
            ...
            <!-- Documents -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">{{ $product->documents && count($product->documents) > 0 ? 'Add More Documents' : 'Documents' }}</h2>
