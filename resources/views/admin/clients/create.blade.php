...
<div class="mb-8">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Add a new client to showcase your business partnerships.</p>
        </div>
        ...
        <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl">
            <div class="p-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <!-- Logo -->
                    <div class="sm:col-span-2">
                        <label for="logo" class="block text-sm font-medium leading-6 text-gray-900">Client Logo *</label>
                        <div class="mt-2">
                            <input type="file" 
                                   name="logo" 
                                   id="logo"
                            ...
                            @error('logo')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-sm text-gray-500">Upload JPG, PNG, SVG, or WebP file (max 5MB). Recommended: 300x150px</p>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                            <textarea name="description" 
                                      ...
                                      rows="4"
                                      class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                                      placeholder="Brief description about the client partnership...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
