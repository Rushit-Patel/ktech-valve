        ...
        <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl">
            <div class="p-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    @if($banner->image)
                    <div class="sm:col-span-2">
                        <label class="block text-sm font-medium leading-6 text-gray-900">Current Banner Image</label>
                        <div class="mt-2">
                            <div class="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                <img src="{{ Storage::url($banner->image) }}" 
                                     alt="{{ $banner->title }}" 
                                     class="h-20 w-auto max-w-32 object-cover bg-white rounded border">
                                <div class="flex-1">
                                    <p class="text-sm font-medium text-gray-900">{{ $banner->title }}</p>
                                    <p class="text-xs text-gray-500">{{ basename($banner->image) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
